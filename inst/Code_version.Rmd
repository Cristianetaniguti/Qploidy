...
clusterExport(clust, c("get_logR", "get_logR_par", "ploidy"))zu
...
# Overal break counts
## Load curated data
aneuploids <- read.csv("C:/Users/Rose_Lab/Documents/Cris_temp/Qploidy_data/roses_final_Qploidy.csv")
...
library(mappoly)
plot(haplo_mappoly, ind = "X16035_N016", lg = 1)
