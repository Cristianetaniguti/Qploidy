...
fitpoly_input_sele <- vroom("fitpoly_input_refs_roses_texas.txt")

saveMarkerModels(ploidy=4,
                 data=fitpoly_input_sele,
                 p.threshold=0.9,
                 filePrefix="fitpoly_out_roses_texas",
                 ncores=30)
...
p <- plot_one_marker(lst_interpolation[[11]], ploidy = 4)
p
...
vroom_write(bafs_diplo_df, file = "baf_roses_texas.txt")
vroom_write(logRs_diplod_m, file = "logR_roses_texas.txt")
