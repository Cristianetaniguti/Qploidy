...
## Visualizing Copy Number Results

To visualize the HMM results, use the `plot_cn_track` function. This produces a genome-wide track for each window, showing the called CN and the confidence (posterior probability) for each call. The top panel shows z-scores, and the bottom panel shows CN segments colored by confidence.
